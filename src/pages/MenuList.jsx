...
const menus = [
  ['01', 'Waffle Combo', 'Breakfast', '2026-04-10', '2026-04-20', 'Admin'],
  ['02', 'Chocolate Waffle', 'Desserts', '2026-04-11', '2026-04-21', 'Admin'],
  ['03', 'Iced Latte', 'Beverages', '2026-04-12', '2026-04-22', 'Admin'],
  ['04', 'Fruit Bowl', 'Snacks', '2026-04-13', '2026-04-23', 'Admin'],
  ['05', 'Seasonal Special', 'Seasonal', '2026-04-14', '2026-04-24', 'Admin'],
  ['06', 'Mini Combo', 'Combos', '2026-04-15', '2026-04-25', 'Admin'],
]
    ...
    <main className="flex min-h-screen bg-[#fffdf8] text-[#6b2a1f]">
      ...
      <section className="flex min-h-screen flex-1 flex-col px-5 py-4 sm:px-6">
        ...
        <div className="mt-4 flex items-center justify-between gap-3">
          <h1 className="text-[18px] font-medium text-[#19110f]">Menus</h1>
          <Button
            buttonName="Create"
            ...
            <tbody>
              {menus.map((row, index) => (
                <tr
                  ...
                  onClick={() => navigate(`/menus/${row[0]}`)}
                >
                  {row.map((cell, cellIndex) => (
                    <td
                      key={`${row[0]}-${cellIndex}`}
                      className={`border-b border-r border-[#cfc1ba] px-3 py-2 first:border-l ${index === menus.length - 1
                          ? cellIndex === 0
                            ? 'rounded-bl-[10px]'
